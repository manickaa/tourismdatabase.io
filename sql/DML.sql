...
SELECT travel_location.travelLocation_ID, CONCAT(travel_location.city, ', ', travel_location.country) AS location FROM travel_location

-- Get all tour guides names to populate tour guide dropdowns
SELECT tourGuide_ID, CONCAT(tour_guide.first_name, ' ', tour_guide.last_name) as guide FROM tour_guide
